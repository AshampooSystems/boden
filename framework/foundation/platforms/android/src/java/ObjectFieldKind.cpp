...
namespace bdn
{
    namespace java
    {
        ...
        void ObjectFieldKind::setObjectField(jobject obj, jfieldID fieldId,
                                             jobject value)
        {
            // note that this JNI call never throws a Java-side exception
        ...
        void ObjectFieldKind::setBooleanField(jobject obj, jfieldID fieldId,
                                              jboolean value)
        {
            // note that this JNI call never throws a Java-side exception
        ...
        void ObjectFieldKind::setIntField(jobject obj, jfieldID fieldId,
                                          jint value)
        {
            // note that this JNI call never throws a Java-side exception
        ...
        void ObjectFieldKind::setByteField(jobject obj, jfieldID fieldId,
                                           jbyte value)
        {
            // note that this JNI call never throws a Java-side exception
        ...
        void ObjectFieldKind::setShortField(jobject obj, jfieldID fieldId,
                                            jshort value)
        {
            // note that this JNI call never throws a Java-side exception
        ...
        void ObjectFieldKind::setLongField(jobject obj, jfieldID fieldId,
                                           jlong value)
        {
            // note that this JNI call never throws a Java-side exception
        ...
        void ObjectFieldKind::setCharField(jobject obj, jfieldID fieldId,
                                           jchar value)
        {
            // note that this JNI call never throws a Java-side exception
        ...
        void ObjectFieldKind::setFloatField(jobject obj, jfieldID fieldId,
                                            jfloat value)
        {
            // note that this JNI call never throws a Java-side exception
        ...
        void ObjectFieldKind::setDoubleField(jobject obj, jfieldID fieldId,
                                             jdouble value)
        {
            // note that this JNI call never throws a Java-side exception
