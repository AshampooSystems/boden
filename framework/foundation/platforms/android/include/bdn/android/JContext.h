#ifndef BDN_ANDROID_JContext_H_
#define BDN_ANDROID_JContext_H_
    ...
    namespace android
    {
        ...
        class JContext : public bdn::java::JObject
        {
          public:
             ...
             * and pass the result.
             *      */
            explicit JContext(const bdn::java::Reference &javaRef)
                : JObject(javaRef)
            {}
            ...
            JResources getResources()
            {
                ...
                return invoke_<JResources>(getStaticClass_(), methodId,
                                           "getResources");
            }
        };
    }
