...
namespace bdn::java
{
    ...
    template <> inline jshort callJavaStaticMethodStoreExceptV<jshort>(jclass cls, jmethodID methodId, va_list argList)
    {
        return callJavaStaticShortMethodStoreExceptV(cls, methodId, argList);
    }

    template <> inline jlong callJavaStaticMethodStoreExceptV<jlong>(jclass cls, jmethodID methodId, va_list argList)
    {
        return callJavaStaticLongMethodStoreExceptV(cls, methodId, argList);
    }

    template <> inline jchar callJavaStaticMethodStoreExceptV<jchar>(jclass cls, jmethodID methodId, va_list argList)
    {
        return callJavaStaticCharMethodStoreExceptV(cls, methodId, argList);
    }

    template <> inline jfloat callJavaStaticMethodStoreExceptV<jfloat>(jclass cls, jmethodID methodId, va_list argList)
    {
     ...
     *
     **/
    template <typename JavaReturnType> inline JavaReturnType callJavaStaticMethod(jclass cls, jmethodID methodId, ...)
    {
        va_list argList;
