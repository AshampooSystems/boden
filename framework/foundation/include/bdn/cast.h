...
namespace bdn
{
    ...
    /** Tries to cast the specified object pointer to a DestType pointer
        ...
        */
    template <class DestType> const DestType *tryCast(const IBase *pObject)
    {
    ...
    /** Casts specified object pointer to a DestType pointer (DestType is the
       ...
       have a compatible type.
        ...
        If pObject is nullptr then cast simply returns nullptr - no matter what
       the type of the input pointer was.

        */
    template <class DestType> DestType *cast(IBase *pObject)
    {
    ...
    /** Casts specified object pointer to a DestType pointer (DestType is the
        ...
        */
    template <class DestType> const DestType *cast(const IBase *pObject)
    {
