...
namespace bdn
{
	namespace android
	{
        ...
        class JListAdapter : public bdn::java::JObject
        {
          ...
          public:
            JListAdapter(JContext &context) : bdn::java::JObject(newInstance_(context)) {}
             ...
             * and pass the result.
             *      */
            explicit JListAdapter(const bdn::java::Reference &javaRef) : bdn::java::JObject(javaRef) {}
            ...
            {
                static bdn::java::JClass cls("android/widget/ListAdapter");
