...
namespace bdn::android::wrapper
{
    ...
    class HorizontalScrollView : public FrameLayout
    {
      ...
      public:
         ...
         * and pass the result.
         *      */
        explicit HorizontalScrollView(const bdn::java::Reference &objectRef) : FrameLayout(objectRef) {}

        HorizontalScrollView(Context context) : HorizontalScrollView(newInstance_(context)) {}
        ...
        */
        ...
        {
            static bdn::java::wrapper::Class cls("android/widget/HorizontalScrollView");
