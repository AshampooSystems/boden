...
namespace bdn
{
    namespace test
    {
        ...
        /** A mixin class that adds implementations of web view specific
        ...
        {
          public:
            TestWebemsViewCoreMixin() : _domObject(emscripten::val::null()) {}
          ...
          protected:
            void initCore() override
            {
                ...
                _pWebCore = cast<bdn::webems::ViewCore>(
            ...
            void verifyCoreVisibility() override
            {
                ...
                String vis = _domObject["style"]["visibility"]
                                 .template as<std::string>();
                REQUIRE(vis == String(expectedVisible ? "visible" : "hidden"));
            }

            std::string getValueAsString(emscripten::val obj,
            ...
            double getValueAsDipDouble(emscripten::val obj,
                                       const char *valueName)
            {
                std::string val = getValueAsString(obj, valueName);

                // do not use as<int>. It can cause crashes when the value is
                // incompatible
                if (val.empty())
                    return 0;
            ...
            void verifyCorePadding() override
            {
                ...
                if (expectedPad.isNull()) {
                    // the padding object apparently ALWAYS exists in the style
                    // object. This seems to be a special handling by the DOM.
                    ...
                    Margin expectedDipPadding =
                        BaseClass::_pView->uiMarginToDipMargin(expectedPad);
