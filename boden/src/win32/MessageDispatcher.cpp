...
MessageDispatcher::MessageDispatcher()
	: RequireNewAlloc<MessageWindowBase, MessageDispatcher>("bdn::win32::MessageDispatcher")
{
}
...
void MessageDispatcher::enqueue(
...
void MessageDispatcher::postCall(ISimpleCallable* pCallable)
{
	pCallable->addRef();
