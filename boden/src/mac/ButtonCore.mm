...
void ButtonCore::_updateBezelStyle()
{
    ...
    // which will look somewhat "non-standard" because it has different highlights.
    
    // we switch to the non-standard bezel style when our height "significantly"
    // exceeds the fixed height we get with the standard bezel.
