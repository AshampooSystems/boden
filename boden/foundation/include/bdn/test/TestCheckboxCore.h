...
protected:
    ...
    /** Verifies that the checkbox's core's label has the expected value
        (the label set in the outer checkbox object's Checkbox::label() property.*/
    virtual void verifyCoreLabel()=0;

    /** Verifies that the checkbox's core's on state has the expected value
        (the on state set in the outer checkbox object's Checkbox::on() property.*/
