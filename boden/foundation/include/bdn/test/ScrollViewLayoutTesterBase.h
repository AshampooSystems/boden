            ...
            */
            ...
            void testLayout()
            {
                ...
                SECTION("contentview not null")
                {
                    ...
                    // if the ScrollView is too small. On Firefox Linux the
                    // minimum size is around 42 pixels. On Firefox for Mac it
                    // is around 12 pixels. So we should make sure that our
                    // scrollview is well over these limits.
