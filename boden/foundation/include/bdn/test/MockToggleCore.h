...
/** Implementation of a "fake" toggle core that does not actually show anything
    visible, but behaves otherwise like a normal toggle core.
...
{
public:
	MockToggleCore(Toggle* pToggle)
		: MockViewCore(pToggle)
	{
