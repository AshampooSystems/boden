...
public:
    ...
    using ConstReverseIterator = typename StdMapCollection< std::map<KEYTYPE, VALTYPE, COMPAREFUNCTYPE, ALLOCATOR> >::const_reverse_iterator;
    ...
    Map(    InputIt beginIt,
        ...
        : StdMapCollection< std::map<KEYTYPE, VALTYPE, COMPAREFUNCTYPE, ALLOCATOR> >( beginIt, endIt, compareFunc, alloc )
    {
    }
    ...
    Map(    InputIt beginIt,
        ...
        : StdMapCollection< std::map<KEYTYPE, VALTYPE, COMPAREFUNCTYPE, ALLOCATOR> >( beginIt, endIt, COMPAREFUNCTYPE(), alloc)
    {
    }
    ...
    Map( Map&& other )
        : StdMapCollection< std::map<KEYTYPE, VALTYPE, COMPAREFUNCTYPE, ALLOCATOR> >( std::move( static_cast<std::map<KEYTYPE, VALTYPE, COMPAREFUNCTYPE, ALLOCATOR>&&>(other) ) )
    {
    }
    ...
    Map( Map&& other, const ALLOCATOR& alloc )
        : StdMapCollection< std::map<KEYTYPE, VALTYPE, COMPAREFUNCTYPE, ALLOCATOR> >( std::move( static_cast<std::map<KEYTYPE, VALTYPE, COMPAREFUNCTYPE, ALLOCATOR>&&>(other) ), alloc )
    {
    }
