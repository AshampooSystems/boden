...
/** StringData class for the 'native' character encoding. On Windows this is
   wide char (UTF-16) and on other systems this is currently UTF-8. Other
   encoding might be used on some systems when new implementations are added.

    This is currently a typedef to either StringData<Utf8Codec> or
   StringData<Utf16Codec>
    - but you should not depend on this fact, since new target systems might use
   other encodings.
