    ...
    namespace win32
    {
        ...
        class UiAppRunner : public AppRunnerBase, BDN_IMPLEMENTS IDispatcher
        {
          public:
            ...
            bool isCommandLineApp() const override { return false; }

            P<IDispatcher> getMainDispatcher() override { return this; }
          ...
          private:
            ...
            class AppMessageWindow : public MessageWindowBase
            {
              public:
                                           ...
                                           WPARAM wParam, LPARAM lParam)
                {
                    ...
                    _pAppRunnerWeak->handleAppMessage(context, windowHandle,
            ...
            void handleAppMessage(MessageWindowBase::MessageContext &context,
                                  HWND windowHandle, UINT message,
                                  WPARAM wParam, LPARAM lParam);

            bool executeAndRemoveItem(List<std::function<void()>> &queue,
                                      bool *pHaveMoreWaiting = nullptr);
