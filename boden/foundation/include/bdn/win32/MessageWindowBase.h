...
namespace bdn
{
    namespace win32
    {
        ...
        /** Base class for special windows that are only used to receive window
           messages and are not visible to the user.
        ...
        */
        ...
        {
          public:
            /** @param windowName the name of the window. Since the window is
               invisible this is mainly useful for debugging and logging and if
               some process needs to find the window by its name.*/
          ...
          protected:
            class MessageWindowClass : public Win32WindowClass
            {
              public:
                MessageWindowClass()
                    : Win32WindowClass("bdn::MessageWindow",
