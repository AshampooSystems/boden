...
namespace bdn
{
    namespace winuwp
    {
        ...
        {
          private:
            static ::Windows::UI::Xaml::Controls::TextBlock ^
                _createTextBlock(TextView *pOuter) {
                    BDN_WINUWP_TO_STDEXC_BEGIN;

                    ::Windows::UI::Xaml::Controls::TextBlock ^ pTextBlock =
                        ref new ::Windows::UI::Xaml::Controls::TextBlock();

                    pTextBlock->TextWrapping =
                        ::Windows::UI::Xaml::TextWrapping::WrapWholeWords;
                    pTextBlock->TextTrimming =
                        ::Windows::UI::Xaml::TextTrimming::None;
                ...
                : ChildViewCore(pOuter, _createTextBlock(pOuter),
            ...
            void setPreferredSizeHint(const Size &hint) override
            {
                ...
                // the preferred width hint is the width at which the text view
                // should auto-wrap its text. We implement this by setting a
                // limit for the available space that we pass to the control.

                setMeasureAvailableSpaceMaximum(
                    Size(hint.width, Size::componentNone()));
          ...
          protected:
            ...
            {
                // text views can adjust the text wrapping to reduce their
                // width.
                return true;
            }
