        ...
        class UiProvider : public Base, BDN_IMPLEMENTS IUiProvider
        {
          public:
            UiProvider()
            {
                ...
                // The default font size for controls is documented as 11 DIPs.
                // So we use that in the meantime.
                _semDips = 11;

                Windows::UI::ViewManagement::ApplicationView ^ pAppView =
                ...
                Windows::Graphics::Display::DisplayInformation ^ pDisplayInfo =
                ...
                pDisplayInfo->DpiChanged +=
                    ref new Windows::Foundation::TypedEventHandler<
                        Windows::Graphics::Display::DisplayInformation ^,
                        Platform::Object ^>(_pEventForwarder,
                                            &EventForwarder::dpiChanged);
            ...
            ~UiProvider() { _pEventForwarder->dispose(); }
          ...
          protected:
            ...
            {
                internal : EventForwarder(UiProvider *pParent)
                {
                    _pParentWeak = pParent;
                }

              public:
                void dpiChanged(Windows::Graphics::Display::DisplayInformation ^
                                    pDisplayInfo,
                ...
                internal : Mutex _parentMutex;
                UiProvider *_pParentWeak;
            };

            void updateUiScaleFactor(
                Windows::Graphics::Display::DisplayInformation ^ pDisplayInfo)
            {
                BDN_WINUWP_TO_STDEXC_BEGIN;
