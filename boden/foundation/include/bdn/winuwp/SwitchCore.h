          ...
          private:
            static ::Windows::UI::Xaml::Controls::StackPanel ^
                _createSwitch(T *pOuter) {
                    ...
                    ::Windows::UI::Xaml::Controls::ToggleSwitch ^ toggle =
                        ref new ::Windows::UI::Xaml::Controls::ToggleSwitch();
                ...
                /** Used internally.*/
                ref class SwitchCoreEventForwarder
                : public ViewCoreEventForwarder
            {
                internal : SwitchCoreEventForwarder(SwitchCore *pParent)
            ...
            SwitchCore(T *pOuter)
                : ChildViewCore(pOuter, _createSwitch(pOuter),
                                ref new SwitchCoreEventForwarder(this))
            {
                BDN_WINUWP_TO_STDEXC_BEGIN;
                ...
                SwitchCoreEventForwarder ^ pEventForwarder =
                    dynamic_cast<SwitchCoreEventForwarder ^>(
                        getViewCoreEventForwarder());
                _pToggle->Toggled +=
                    ref new ::Windows::UI::Xaml::RoutedEventHandler(
                        pEventForwarder, &SwitchCoreEventForwarder::toggled);
