...
/** Provides a filtered version of the specified base \ref sequence.md "sequence", according to the specified filtering function.
    ...
    A "sequence" is simply an object that provides begin() and end() functions, which return \ref iterator.md "iterator" objects
    to the elements of the sequence (\ref sequence.md "more information").
    ...
    The filter function gets two parameters: a reference to the base sequence object and an iterator from the base sequence.
