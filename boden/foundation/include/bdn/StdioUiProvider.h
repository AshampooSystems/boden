...
/** IUiProvider implementation that provides uses stdio streams to communicate with the user
    
    The current implementation does not provide any bdn::View implementations. But it does support
    ITextUi (see getTextUi() ).
*/
