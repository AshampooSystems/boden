...
namespace bdn
{
    ...
    bool _isDebuggerActive()
    {
        ...
        if (sysctl(mib, sizeof(mib) / sizeof(*mib), &info, &size, nullptr, 0) !=
            0) {
            // unable to determine if debugger is running. Assuming that it is
            // not.
            return false;
        }
...
namespace bdn
{
    ...
    bool _isDebuggerActive() { return ::IsDebuggerPresent() != 0; }
}
...
namespace bdn
{
    ...
    bool debuggerPrintGoesToStdErr() { return false; }
}
...
namespace bdn
{
    ...
    bool debuggerPrintGoesToStdErr() { return true; }
}
