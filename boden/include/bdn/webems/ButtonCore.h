...
protected:    
    ...
    void setNonDefaultPadding(const Margin& padding) override
    {
        ...
        // on Mozilla browsers the padding for buttons is ignored or not applied
        // to the actual button interior (instead it is applied as an additional margin).
        // We want the padding to have an actual effect. To achieve that, we have to set
        // the appearance to "none", to get an "unstyled" button, that will follow the
        // padding we set.
