...
/** Indicates an error reported by the operating system or another component that returns
	operating system error codes.

	If you want to throw a SystemError then you should take a look at throwSysError() and
	...
	That means that the following will catch both bdn::SystemError AND std::system_error
	exceptions.
