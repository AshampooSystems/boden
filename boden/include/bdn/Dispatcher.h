...
public:
    ...
    /** Used internally - do not call.
		See the global functions callFromMainThread() instead. */
	static void _callFromMainThreadImpl( std::function< void() > func );    
    
};


class CallFromMainThreadBase_
{
public:
	~CallFromMainThreadBase_();
...
{
	CallFromMainThread_* pCall = new CallFromMainThread(func, args...);
