...
template<>
inline void callJavaStaticMethodStoreExceptV<void>(jclass cls, jmethodID methodId, va_list argList)
{
    callJavaStaticVoidMethodStoreExceptV(cls, methodId, argList);
}

template<>
inline jint callJavaStaticMethodStoreExceptV<jint>(jclass cls, jmethodID methodId, va_list argList)
{
...
/** Calls Java-side static functions with the return type specified by the
 ...
 *  \code
 *
 *  bool returnValue = StaticMethodCaller<bool>::call( obj, methodId, arg1, arg2, ...);
 *
 *  \endcode
 *
...
public:
    ...
    {
        return javaToNative<NativeReturnType>( callJavaStaticMethod<JavaReturnType>(cls, methodId, nativeToJava(args)... ) );
    }
};


template<>
class StaticMethodCaller<void>
{
public:
    ...
    {
        callJavaStaticMethod<void>(cls, methodId, nativeToJava(args)... );
    }
};
