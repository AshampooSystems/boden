...
/** Implementation of a "fake" TextField core that does not actually show anything
    visible, but behaves otherwise like a normal TextField core.
...
{
public:
	MockTextFieldCore(TextField* pTextField)
		: MockViewCore(pTextField)
	{
