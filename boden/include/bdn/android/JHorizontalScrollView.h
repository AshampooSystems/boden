#ifndef BDN_ANDROID_JHorizontalScrollView_H_
#define BDN_ANDROID_JHorizontalScrollView_H_
...
public:
    ...
    *      */
    explicit JHorizontalScrollView(const bdn::java::Reference& objectRef)
