...
void testAsyncStdioReader()
{
    ...
    {
        P< AsyncStdioReader_OneAtTheTimeTestContext<CharType> > pContext = newObj< AsyncStdioReader_OneAtTheTimeTestContext<CharType> >();
    ...
    SECTION("all at once")
    {
        P< AsyncStdioReader_AllAtOnceTestContext<CharType> > pContext = newObj< AsyncStdioReader_AllAtOnceTestContext<CharType> >();
