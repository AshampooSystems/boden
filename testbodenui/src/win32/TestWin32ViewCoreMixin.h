...
/** A mixin class that adds implementations of win32 view specific functionality on top of
...
protected:
    ...
    void verifyCoreVisibility() override
    {
        ...
        REQUIRE( ((::GetWindowLong( _hwnd, GWL_STYLE) & WS_VISIBLE)==WS_VISIBLE) == expectedVisible );
    }
    ...
    {        
        Rect rect = getWindowRectInParent();
        Rect expectedRect = _pView->bounds();
