...
TEST_CASE("win32.Win32Window")
{
    SECTION("notifyDestroy called")
    {
        ...
        pWindow->_notifyDestroyFunc = [&notifyDestroyCallCount](){ notifyDestroyCallCount++;};
        ...
        SECTION("destructor")
        {
            ...
            // while the base class destructor destroys the window, we will not be notified in that case,
            // because the derived class is destroyed first. So our overload of notifyDestroy does not
